...
export default function ItemsScreen() {
  ...
  const inspectionType = state.type; // simple | technical | rental

  let baseChecklist;

if (inspectionType === "technical") {
  baseChecklist = areaType === "internal"
    ? TECH_INTERNAL
    : TECH_EXTERNAL;
                  ...
                  {section.tests.map((test, index) => (
                    ...
                    >
                        <View style={{ marginBottom: 8 }}>
                          <Text style={{ fontSize: 13, color: "#333", lineHeight: 18, fontWeight: "600" }}>
                           {test.description}
                          </Text>
